...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let detailVC = storyboard?.instantiateViewController(withIdentifier: "detailViewController") as! ViewControllerDetails
        navigationController?.show(detailVC, sender: self)
        detailVC.tittle = arrayTask[indexPath.row].name
        detailVC.labelD = arrayTask[indexPath.row].detailsTask
